...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <a href="employee.php" class="brand-link">
    <img src="../dist/img/logo.png" alt="Swalayan Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">Swalayan Barokah</span>
  </a>
  <div class="sidebar">
